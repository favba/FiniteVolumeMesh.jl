...
@inline normal_to_2Dline(I::NTuple{2,Integer},nodes::Vector{<:Vec2D}) = @inbounds normal_to_2Dline(nodes[I[1]], nodes[I[2]])

@inline line_center(n1::AbstractVec,n2::AbstractVec) = 0.5*(n1+n2)
@inline line_center(I::NTuple{2,Integer},nodes::Vector{<:Vec2D}) = @inbounds line_center(nodes[I[1]], nodes[I[2]])